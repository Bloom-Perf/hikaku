...
describe("createSnapshot", () => {
  ...
  it("groups metrics by scenario and iteration", async () => {
    ...
    browserRequest.inc(
      { hostname: "a.com", scenario: "Login", iteration: 0 },
      5,
    );
    browserRequest.inc(
      { hostname: "a.com", scenario: "Login", iteration: 1 },
      3,
    );
    browserRequest.inc(
      { hostname: "a.com", scenario: "Checkout", iteration: 0 },
      7,
    );
  ...
  it("handles multiple hostnames within a scenario", async () => {
    ...
    browserRequest.inc(
      { hostname: "api.com", scenario: "Login", iteration: 0 },
      5,
    );
    browserRequest.inc(
      { hostname: "cdn.com", scenario: "Login", iteration: 0 },
      3,
    );
